...
export default function GlobalError({
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: '24px', background: '#F4F7F4', color: '#143828', fontFamily: 'system-ui, -apple-system, Segoe UI, sans-serif' }}>
